...
_C.MODEL.EMBED_DIM = 1 # should only be either 0 or 1
...
_C.MODEL.LAMBDA = 1e-8
_C.MODEL.USE_CONTRAST_PROJECTOR = False
_C.MODEL.CONTRAST_LAYER = 'embedder' # {'embedder', 'decoder', or int from 0 to NUM_LAYER-1}

_C.MODEL.LINEAR_PROJECTOR = False
...
_C.TRAIN.DO_CONTRAST = True
_C.TRAIN.CONTRAST_MASK_RATIO = 0.2
_C.TRAIN.CONTRAST_MASK_TOKEN_RATIO = 1.0 # We don't need this if we use zero mask
_C.TRAIN.CONTRAST_MASK_RANDOM_RATIO = 0.5 # Of the non-replaced, what percentage should be random?
_C.TRAIN.CONTRAST_MASK_MODE = "timestep" # ["full", "timestep"]
_C.TRAIN.CONTRAST_MASK_MAX_SPAN = 1
_C.TRAIN.CONTRAST_MASK_SPAN_RAMP_START = 600
_C.TRAIN.CONTRAST_MASK_SPAN_RAMP_END = 1200
...
_C.TRAIN.FINETUNE_PATIENCE = 750
_C.TRAIN.FINETUNE_LOG_INTERVAL = 50
_C.TRAIN.FINETUNE_VAL_INTERVAL = 1
