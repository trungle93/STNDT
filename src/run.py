...
def get_parser():
    ...
    parser.add_argument(
        ...
        default=None,
        type=str,
        help="full path to the directory storing ray results"
    )
...
def main():
    ...
    args_dict = vars(args)
    ray_results_dir = args_dict['ray_results_dir']
...
def run_exp(exp_config: Union[List[str], str], run_type: str, ckpt_path="", clear_only=False, opts=None, suffix=None, ray_results_dir=None) -> None:
